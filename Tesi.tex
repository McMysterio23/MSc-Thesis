...
\title{{ \texttt{The effect of temporal jitter on single photon indistinguishability}}}
...
\supervisor{Wolfgang Loeffler}                         % Note that this should be a LION staff member!
\corrector{Evert van Nieuwenburg}                   % This could be a LION staff member or your external supervisor
